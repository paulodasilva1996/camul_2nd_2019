...
class _MyHomePageState extends State<_MyHomePage> {
  ...
  HandleDetection _getDetectionMethod() {
    ...
    switch (_currentDetector) {
      ...
      default:
        ...
        var options =  new FaceDetectorOptions(enableClassification: true, enableLandmarks: true, enableTracking: true, mode: FaceDetectorMode.accurate); 
        return mlVision.faceDetector(options).processImage;
    }
  }
  ...
  Widget _buildResults() {
    ...
    switch (_currentDetector) {
      ...
      case Detector.face:
        ...
        painter = FaceDetectorPainter(imageSize, _scanResults, _imageDetected);
        //saveImage();
        break;
      case Detector.label:
  ...
  void saveImage () async {
    try {
      final img = await saveImageToFile (_imageDetected); 
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Retrato para toda gente'),
