...
class FaceDetectorPainter extends CustomPainter {
  FaceDetectorPainter(this.imageSize, this.faces, this.image);
  final Size imageSize;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (Face face in faces) {
      ...
      var a = face.smilingProbability;
      var b = face.trackingId;
      saveImage();
      print ("detected face, smilling probability : $a , tracking id: $b");
    }
  }

  void saveImage () async {
    final img = await saveImageToFile (this.image); 
    print ("path to save image is ");
  }
